...
BITMAP *init_dist_n(Params *p, BITMAP *a, BITMAP *b, BITMAP *ann, BITMAP *bmask, RegionMasks *region_masks, RegionMasks *amask, BOOLMAP *ROI) {
...
void nn_n(Params *p, BITMAP *a, BITMAP *b,
          ...
          int level, int em_iter, RecomposeParams *rp, int offset_iter, int update_type, RegionMasks *region_masks, int tiles,
					BITMAP *ann_window, BITMAP *awinsize, BOOLMAP *ROI) 
{

  printf("in nn_n, masks are: %p %p %p, tiles=%d\n", amask, bmask, region_masks, tiles);
  // cout << "In nn_n ROI = " << ROI << endl;
  Box box = get_abox(p, a, amask);
  int nn_iter = 0;
  ...
  for (; nn_iter < p->nn_iters; nn_iter++) {
    ...
    for (int y = ystart; y != yfinal; y += ychange) {
      ...
      for (int x = xstart; x != xfinal; x += xchange) {
        ...
        if( ROI && !ROI->line[y][x] ) { /*cout << "BACKGR, ROI[y,x] = " << ROI->line[y][x] << endl;*/ continue; }
        //else { cout << "GHOST, ROI = " << ROI->line[y][x] << endl; }
...
BITMAP *init_nn(Params *p, BITMAP *a, BITMAP *b, BITMAP *bmask, RegionMasks *region_masks, RegionMasks *amask, int trim_patch, BITMAP *ann_window, BITMAP *awinsize, BOOLMAP *ROI) {
...
BITMAP *init_dist(Params *p, BITMAP *a, BITMAP *b, BITMAP *ann, BITMAP *bmask, RegionMasks *region_masks, RegionMasks *amask, BOOLMAP *ROI) {
  BITMAP *ans = NULL;

  if (is_window(p)) {
    if      (p->patch_w == 1) { ans = init_dist_n<1,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 2) { ans = init_dist_n<2,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 3) { ans = init_dist_n<3,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 4) { ans = init_dist_n<4,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 5) { ans = init_dist_n<5,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 6) { ans = init_dist_n<6,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 7) { ans = init_dist_n<7,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 8) { ans = init_dist_n<8,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 9) { ans = init_dist_n<9,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 10) { ans = init_dist_n<10,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 11) { ans = init_dist_n<11,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 12) { ans = init_dist_n<12,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 13) { ans = init_dist_n<13,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 14) { ans = init_dist_n<14,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 15) { ans = init_dist_n<15,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 16) { ans = init_dist_n<16,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 17) { ans = init_dist_n<17,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 18) { ans = init_dist_n<18,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 19) { ans = init_dist_n<19,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 20) { ans = init_dist_n<20,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 21) { ans = init_dist_n<21,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 22) { ans = init_dist_n<22,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 23) { ans = init_dist_n<23,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 24) { ans = init_dist_n<24,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 25) { ans = init_dist_n<25,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 26) { ans = init_dist_n<26,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 27) { ans = init_dist_n<27,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 28) { ans = init_dist_n<28,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 29) { ans = init_dist_n<29,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 30) { ans = init_dist_n<30,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 31) { ans = init_dist_n<31,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 32) { ans = init_dist_n<32,1,1>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else { fprintf(stderr, "Patch size unsupported: %d\n", p->patch_w); exit(1); }
  } 
	else if (amask || bmask || region_masks) {
    //printf("init_dist is masked\n");
    if      (p->patch_w == 1) { ans = init_dist_n<1,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 2) { ans = init_dist_n<2,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 3) { ans = init_dist_n<3,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 4) { ans = init_dist_n<4,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 5) { ans = init_dist_n<5,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 6) { ans = init_dist_n<6,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 7) { ans = init_dist_n<7,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 8) { ans = init_dist_n<8,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 9) { ans = init_dist_n<9,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 10) { ans = init_dist_n<10,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 11) { ans = init_dist_n<11,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 12) { ans = init_dist_n<12,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 13) { ans = init_dist_n<13,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 14) { ans = init_dist_n<14,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 15) { ans = init_dist_n<15,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 16) { ans = init_dist_n<16,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 17) { ans = init_dist_n<17,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 18) { ans = init_dist_n<18,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 19) { ans = init_dist_n<19,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 20) { ans = init_dist_n<20,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 21) { ans = init_dist_n<21,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 22) { ans = init_dist_n<22,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 23) { ans = init_dist_n<23,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 24) { ans = init_dist_n<24,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 25) { ans = init_dist_n<25,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 26) { ans = init_dist_n<26,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 27) { ans = init_dist_n<27,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 28) { ans = init_dist_n<28,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 29) { ans = init_dist_n<29,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 30) { ans = init_dist_n<30,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 31) { ans = init_dist_n<31,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 32) { ans = init_dist_n<32,1,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
		else { fprintf(stderr, "Patch size unsupported: %d\n", p->patch_w); exit(1); }
  } 
	else {
    //printf("init_dist is unmasked\n");
    if      (p->patch_w == 1) { ans = init_dist_n<1,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 2) { ans = init_dist_n<2,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 3) { ans = init_dist_n<3,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 4) { ans = init_dist_n<4,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 5) { ans = init_dist_n<5,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 6) { ans = init_dist_n<6,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 7) { ans = init_dist_n<7,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 8) { ans = init_dist_n<8,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 9) { ans = init_dist_n<9,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 10) { ans = init_dist_n<10,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 11) { ans = init_dist_n<11,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 12) { ans = init_dist_n<12,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 13) { ans = init_dist_n<13,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 14) { ans = init_dist_n<14,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 15) { ans = init_dist_n<15,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 16) { ans = init_dist_n<16,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 17) { ans = init_dist_n<17,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 18) { ans = init_dist_n<18,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 19) { ans = init_dist_n<19,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 20) { ans = init_dist_n<20,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 21) { ans = init_dist_n<21,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 22) { ans = init_dist_n<22,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 23) { ans = init_dist_n<23,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 24) { ans = init_dist_n<24,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 25) { ans = init_dist_n<25,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 26) { ans = init_dist_n<26,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 27) { ans = init_dist_n<27,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 28) { ans = init_dist_n<28,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 29) { ans = init_dist_n<29,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 30) { ans = init_dist_n<30,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 31) { ans = init_dist_n<31,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
    else if (p->patch_w == 32) { ans = init_dist_n<32,0,0>(p, a, b, ann, bmask, region_masks, amask, ROI); }
		else { fprintf(stderr, "Patch size unsupported: %d\n", p->patch_w); exit(1); }
  }
  return ans;
}
...
void nn(Params *p, BITMAP *a, BITMAP *b,
        ...
        RegionMasks *region_masks, int tiles, BITMAP *ann_window, BITMAP *awinsize, BOOLMAP *ROI) {
 //   cout << "Entered nn()" << endl;
  int algo = p->algo;
  if (algo == ALGO_CPU) {
    if (is_window(p)) {
      cout << "Running nn, using windowed and masked" << endl;
      if      (p->patch_w == 1) { nn_n<1,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 2) { nn_n<2,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 3) { nn_n<3,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 4) { nn_n<4,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 5) { nn_n<5,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 6) { nn_n<6,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 7) { nn_n<7,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 8) { nn_n<8,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 9) { nn_n<9,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 10) { nn_n<10,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 11) { nn_n<11,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 12) { nn_n<12,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 13) { nn_n<13,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 14) { nn_n<14,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 15) { nn_n<15,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 16) { nn_n<16,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
			else if (p->patch_w == 17) { nn_n<17,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 18) { nn_n<18,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 19) { nn_n<19,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 20) { nn_n<20,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 21) { nn_n<21,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 22) { nn_n<22,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 23) { nn_n<23,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 24) { nn_n<24,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 25) { nn_n<25,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 26) { nn_n<26,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 27) { nn_n<27,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 28) { nn_n<28,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 29) { nn_n<29,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 30) { nn_n<30,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 31) { nn_n<31,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 32) { nn_n<32,1,1>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else { fprintf(stderr, "Patch size unsupported: %d\n", p->patch_w); exit(1); }
    } 
		else if (bmask == NULL && amask == NULL && region_masks == NULL) {
      cout << "Running nn, using unmasked" << endl;
      if      (p->patch_w == 1) { nn_n<1,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 2) { nn_n<2,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 3) { nn_n<3,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 4) { nn_n<4,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 5) { nn_n<5,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 6) { nn_n<6,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 7) { nn_n<7,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 8) { nn_n<8,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 9) { nn_n<9,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 10) { nn_n<10,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 11) { nn_n<11,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 12) { nn_n<12,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 13) { nn_n<13,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 14) { nn_n<14,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 15) { nn_n<15,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 16) { nn_n<16,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 17) { nn_n<17,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 18) { nn_n<18,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 19) { nn_n<19,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 20) { nn_n<20,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 21) { nn_n<21,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 22) { nn_n<22,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 23) { nn_n<23,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 24) { nn_n<24,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 25) { nn_n<25,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 26) { nn_n<26,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 27) { nn_n<27,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 28) { nn_n<28,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 29) { nn_n<29,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 30) { nn_n<30,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 31) { nn_n<31,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 32) { nn_n<32,0,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else { fprintf(stderr, "Patch size unsupported: %d\n", p->patch_w); exit(1); }
    } 
		else {
      cout << "Running nn, using masked" << endl;
      if      (p->patch_w == 1) { nn_n<1,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 2) { nn_n<2,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 3) { nn_n<3,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 4) { nn_n<4,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 5) { nn_n<5,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 6) { nn_n<6,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 7) { nn_n<7,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 8) { nn_n<8,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 9) { nn_n<9,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 10) { nn_n<10,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 11) { nn_n<11,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 12) { nn_n<12,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 13) { nn_n<13,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 14) { nn_n<14,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 15) { nn_n<15,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 16) { nn_n<16,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 17) { nn_n<17,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 18) { nn_n<18,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 19) { nn_n<19,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 20) { nn_n<20,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 21) { nn_n<21,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 22) { nn_n<22,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 23) { nn_n<23,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 24) { nn_n<24,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 25) { nn_n<25,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 26) { nn_n<26,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 27) { nn_n<27,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 28) { nn_n<28,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 29) { nn_n<29,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 30) { nn_n<30,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 31) { nn_n<31,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else if (p->patch_w == 32) { nn_n<32,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize, ROI); }
      else { fprintf(stderr, "Patch size unsupported: %d\n", p->patch_w); exit(1); }
    }
  } 
	else if (algo == ALGO_CPUTILED) {
    if (is_window(p)) {
      cout << "Running nn cputiled, using windowed and masked" << endl;
      ...
      if (p->rs_max == 0) {
        cout << "Running nn cputiled, using propagation only\n" << endl;
        ...
        cout << "Running nn cputiled, no windows or masks\n" << endl;
      ...
      cout << "Running nn cputiled, using masks\n" << endl;
      if      (p->patch_w == 1) { nn_n_cputiled<1,1,0>(p, a, b, ann, annd, amask, bmask, level, em_iter, rp, offset_iter, update_type, region_masks, tiles, ann_window, awinsize); }
        ...
        cout << "in nn.cpp: algo = ALGO_GPUCPU" << endl;
...
void minnn_n(Params *p, BITMAP *a, BITMAP *b, BITMAP *ann, BITMAP *annd, BITMAP *ann_prev, BITMAP *bmask, int level, int em_iter, RecomposeParams *rp, RegionMasks *region_masks, RegionMasks *amask, int ntiles, BOOLMAP *ROI=NULL) {
  ...
  nn(&pcopy, a, b, ann, annd, amask, bmask, level, em_iter, rp, 0, 0, 1, region_masks, ntiles, NULL, NULL, ROI);
}

void minnn(Params *p, BITMAP *a, BITMAP *b, BITMAP *ann, BITMAP *annd, BITMAP *ann_prev, BITMAP *bmask, int level, int em_iter, RecomposeParams *rp, RegionMasks *region_masks, RegionMasks *amask, int ntiles, BOOLMAP *ROI) {
  if (is_window(p)) {
    if      (p->patch_w == 1 ) { return minnn_n<1 , 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 2 ) { return minnn_n<2 , 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 3 ) { return minnn_n<3 , 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 4 ) { return minnn_n<4 , 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 5 ) { return minnn_n<5 , 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 6 ) { return minnn_n<6 , 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 7 ) { return minnn_n<7 , 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 8 ) { return minnn_n<8 , 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 9 ) { return minnn_n<9 , 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 10) { return minnn_n<10, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 11) { return minnn_n<11, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 12) { return minnn_n<12, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 13) { return minnn_n<13, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 14) { return minnn_n<14, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 15) { return minnn_n<15, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 16) { return minnn_n<16, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 17) { return minnn_n<17, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 18) { return minnn_n<18, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 19) { return minnn_n<19, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 20) { return minnn_n<20, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 21) { return minnn_n<21, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 22) { return minnn_n<22, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 23) { return minnn_n<23, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 24) { return minnn_n<24, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 25) { return minnn_n<25, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 26) { return minnn_n<26, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 27) { return minnn_n<27, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 28) { return minnn_n<28, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 29) { return minnn_n<29, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 30) { return minnn_n<30, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 31) { return minnn_n<31, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 32) { return minnn_n<32, 1, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else { fprintf(stderr, "Patch size unsupported: %d\n", p->patch_w); exit(1); }
  } 
	else if (bmask || region_masks || amask) {
    if      (p->patch_w == 1 ) { return minnn_n<1 , 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 2 ) { return minnn_n<2 , 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 3 ) { return minnn_n<3 , 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 4 ) { return minnn_n<4 , 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 5 ) { return minnn_n<5 , 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 6 ) { return minnn_n<6 , 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 7 ) { return minnn_n<7 , 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 8 ) { return minnn_n<8 , 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 9 ) { return minnn_n<9 , 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 10) { return minnn_n<10, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 11) { return minnn_n<11, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 12) { return minnn_n<12, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 13) { return minnn_n<13, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 14) { return minnn_n<14, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 15) { return minnn_n<15, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 16) { return minnn_n<16, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 17) { return minnn_n<17, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 18) { return minnn_n<18, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 19) { return minnn_n<19, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 20) { return minnn_n<20, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 21) { return minnn_n<21, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 22) { return minnn_n<22, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 23) { return minnn_n<23, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 24) { return minnn_n<24, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 25) { return minnn_n<25, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 26) { return minnn_n<26, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 27) { return minnn_n<27, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 28) { return minnn_n<28, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 29) { return minnn_n<29, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 30) { return minnn_n<30, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 31) { return minnn_n<31, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else if (p->patch_w == 32) { return minnn_n<32, 0, 1>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
		else { fprintf(stderr, "Patch size unsupported: %d\n", p->patch_w); exit(1); }
  } 
	else {
    if      (p->patch_w == 1 ) { return minnn_n<1 , 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 2 ) { return minnn_n<2 , 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 3 ) { return minnn_n<3 , 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 4 ) { return minnn_n<4 , 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 5 ) { return minnn_n<5 , 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 6 ) { return minnn_n<6 , 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 7 ) { return minnn_n<7 , 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 8 ) { return minnn_n<8 , 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 9 ) { return minnn_n<9 , 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 10) { return minnn_n<10, 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 11) { return minnn_n<11, 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 12) { return minnn_n<12, 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 13) { return minnn_n<13, 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 14) { return minnn_n<14, 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 15) { return minnn_n<15, 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
    else if (p->patch_w == 16) { return minnn_n<16, 0, 0>(p, a, b, ann, annd, ann_prev, bmask, level, em_iter, rp, region_masks, amask, ntiles, ROI); }
